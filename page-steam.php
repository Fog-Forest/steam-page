...
<?php
	...
	$steamAPI = "https://api.mushroom.ga/SteamAPI.php";  // SteamAPI，我提供了两个API，更推荐你自建

	// PS: 下面这个图片是实时更新的，有三种样式，用哪种就注释掉其他两个
	echo "<a href=\"https://steamcommunity.com/profiles/".$steamid."\" target=\"_blank\"><img src=\"https://steamsignature.com/profile/schinese/".$steamid.".png\"></a>";  // Profile
	// echo "<a href=\"https://steamcommunity.com/profiles/".$steamid."\" target=\"_blank\"><img src=\"https://steamsignature.com/status/schinese/".$steamid.".png\"></a>";  // Lite Status
	// echo "<a href=\"https://steamcommunity.com/profiles/".$steamid."\" target=\"_blank\"><img src=\"https://steamsignature.com/card/0/".$steamid.".png\"></a>";  // Card
	
	// API_url 拼合
	$api_url = $steamAPI."?id=".$steamid."&type=all";
	require_once("json/classSteam.php");
	$steam = new Steamgame($api_url);
